    ...
    <div className="w-full relative min-h-screen pb-24 z-10">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12">
        ...
        <div className="mb-32 text-center bg-surface-container-low p-8 md:p-16 border border-border/5">
          ...
          <div className="relative w-full max-w-5xl mx-auto aspect-video mb-8 border border-border/20 shadow-2xl overflow-hidden">
             ...
             <BeforeAfterSlider 
               beforeImage={work.beforeAfter?.before} 
               afterImage={work.beforeAfter?.after} 
             />
          </div>
